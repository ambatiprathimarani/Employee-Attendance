    ...
    if ($empid != "" && $password != "") {
        try {
            ...
            if ($count == 1 && !empty($row)) {
                ...
                $msg = "Invalid employee ID and password!";
            }
...
if (isset($_POST['reset'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        echo "<script>alert('Invalid Employee ID or Mobile Number');</script>"; 
    }
}
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Login - Employee Attendance System Admin</title>
  </head>
  <body>
      ...
      <div class="login-box">
        <form class="login-form" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="empid" id="empid" type="text" placeholder="Employee ID" autofocus>
          </div>
          <div class="form-group">
        ...
        <form class="forget-form" method="post">
          ...
          <div class="form-group">
            <label class="control-label">EMPLOYEE ID</label>
            <input class="form-control" type="text" placeholder="Employee ID" name="empid" required>
          </div>
          <div class="form-group">
