    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                        <h2 align="center"> <?php echo date('d-m-Y');?> Attendance</h2>
                        <hr />
...
left join tbldepartment on tblemployee.department_name=tbldepartment.id where date(checkInTime)=CURDATE()";
